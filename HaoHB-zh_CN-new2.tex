...
%\centerline{求职意向: 高性能计算工程师}
%\centerline{求职意向: GPU并行计算工程师}
...
%\vspace{1ex}
\section{\faUsers\ 项目经历}
\datedsubsection{\textbf{AMD GPU矩阵乘和卷积算法的优化}}{2017.06 -- 现在}
%\role{Golang, Linux}{个人项目，和富帅糕合作开发}
\begin{onehalfspacing}
...
%\vspace{2ex}
%\datedsubsection{\textbf{LC-3模拟器 ISA (课程项目 Yale Patt授课)}}{2014.07 -- 2014.08}
%%\role{\LaTeX, Python}{个人项目}
%\begin{onehalfspacing}
%LC-3模拟器汇编迷宫算法递归实现，编写中断调用子程序。
%\begin{itemize}
 %\item 掌握LC-3 ISA。
%\vspace{0.5ex}
% \item 掌握LC-3 ISA,了解用门电路,有限状态机、ALU、控制器构造LC-3模拟器的过程。
%\end{itemize}
%\end{onehalfspacing}
